...
Output: short, disciplined, analytical — not a news summary.
---
Context Setup
...
---
Style Notes
300–400 words maximum for the full update
Analytical, not journalistic
If today was genuinely quiet, the update is short — that is correct
The discipline of saying "nothing significant moved today" is as valuable as finding signal — it builds the record of what matters and what doesn't

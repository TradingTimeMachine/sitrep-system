...
International Crisis Group	`https://www.crisisgroup.org/rss`	Research	Deep regional analysis
...
MarineTraffic	`https://www.marinetraffic.com`	Data	Real-time vessel tracking — Hormuz
...
UN News	`https://news.un.org/feed/subscribe/en/news/region/middle-east/feed/rss.xml`	Official UN coverage
---
...
Use for country-specific coverage in any language

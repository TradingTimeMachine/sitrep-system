...
The reader should feel the place before they are asked to think about it.

### Use the wave rhythm

Kaplan's sentences move in waves. Long, clause-heavy sentences carrying historical sweep and geographical weight, followed by a short one that lands the observation. The ratio runs roughly 3:1 or 4:1 long to short.

The short sentence belongs at the end of a buildup, not at the beginning of one. It is the landing, not the launch.

Build the paragraph through accumulation. Let the weight of the detail do the work. Then, if a short declarative is needed, earn it.
...
Not every section needs a conclusion. Not every analytical question needs a probability estimate attached to it. Some situations are genuinely unresolved and the most honest thing the writing can do is reflect that.

Kaplan ends passages on philosophical, sometimes uncomfortable observations rather than tidy summaries. The SITREP final brief should do the same when the situation warrants it. The 90-day scenario section requires probabilities. The narrative prose does not.

An ending that leaves the reader slightly unsettled, sitting with an unresolved tension, is often more accurate and more valuable than one that resolves cleanly.

### Vary paragraph length aggressively

One paragraph can be a single sentence. The next can run six or seven. The asymmetry is not decorative. It reflects the fact that some observations need space and some do not. Perfect paragraph symmetry is a sign that the writing is following a template rather than following the thought.
...
**The double-emphatic pivot**
Never: "Mali is being dismantled. Not losing ground to an insurgency, but actively, systematically dismantled."
The short sentence followed by its own expansion is a formula, not a thought. State the observation once, fully, and move on.

**The pointing pronoun pivot**
Never begin an analytical sentence with "That matters because," "That is the signal," "This is not X, it is Y," "That silence is not indifference," or any variant. If the preceding sentence was written well enough, the significance does not need to be announced. If it was not written well enough, the pointing pronoun will not save it.

**The grand opening hook**
...
### Banned structural symmetry

Never write a series of regional sections that all follow the same skeleton: data point, contrast, grand conclusion. Sections should have different shapes. Some lead with history. Some lead with a specific person or decision. Some circle back to something introduced earlier. Some end before the analytical point fully lands.

If every section in the brief could be swapped with another section without the reader noticing a difference in register, the writing is following a template.
...
It is the voice of someone who has been paying close attention for a long time and has something worth saying about what they have seen.

That is the standard. Write toward it.

---

## Part IV: Evolution

This document is a living reference. When a new AI cadence pattern appears in a published issue, add it to the banned list. When a passage from a writer whose register is worth emulating surfaces, add it to Part I as an example. The guide compounds over time.

Current calibration sources:
- Robert Kaplan, *The Revenge of Geography* (primary)
